...
export function SettingsTab() {
  ...
  const themes: {
  ...
  }[] = [
    {
      id: "dark",
      label: "Dark Night",
      desc: "Default immersive blue-slate dark mode",
      previewBg: "#0d1117",
      previewText: "#f8fafc",
      accent: "#f97316",
    },
    {
      id: "oled",
      label: "OLED Black",
      desc: "Pure pitch black (#000000) battery saver",
      previewBg: "#000000",
      previewText: "#ffffff",
      accent: "#fbbf24",
    },
    {
      id: "light",
      label: "Paper Light",
      desc: "Crisp daytime reading sheet",
      previewBg: "#f8fafc",
      previewText: "#0f172a",
      accent: "#ea580c",
    },
    {
      id: "sepia",
      label: "Sepia Eye-Care",
      desc: "Warm vintage book tone for long reading",
      previewBg: "#f4ecd8",
      previewText: "#433422",
      accent: "#b45309",
    },
    {
      id: "cyber",
      label: "Cyberpunk",
      desc: "Sleek dark violet cyberpunk aesthetics",
      previewBg: "#090812",
      previewText: "#f3e8ff",
      accent: "#a855f7",
    },
  ...
  const fonts: {
  ...
  }[] = [
    {
      ...
      desc: "Clean geometric sans-serif for high speed reading",
      sample: "Inter, sans-serif",
    },
    {
      id: "serif",
      label: "Book Serif (Merriweather)",
      desc: "Classic book serif typography with organic curves",
      sample: "Merriweather, serif",
    },
    {
      id: "outfit",
      label: "Studio Display (Outfit)",
      desc: "Bold modern display font with distinct personality",
      sample: "Outfit, sans-serif",
    },
    {
      id: "mono",
      label: "Terminal (Fira Code)",
      desc: "Monospace coding aesthetic for raw comparison",
      sample: "Fira Code, monospace",
    },
  ];
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-12 max-w-4xl mx-auto">
      {/* Header */}
      <div
        className="p-6 rounded-3xl border glass-surface"
        style={{ borderColor: "var(--color-border)" }}
      >
        <div className="flex items-center gap-3">
          <div
            className="w-10 h-10 rounded-2xl flex items-center justify-center text-white shadow-lg glow-accent"
            style={{
              background:
          ...
          <div>
            ...
            >
              Customize how novels, themes, and AI translations look across
      ...
      <section className="space-y-4">
          ...
          {fonts.map((f) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className="text-xs opacity-80 font-sans"
                  style={{ color: "var(--color-text-muted)" }}
                >
                  {f.desc}
                </p>
        ...
        <div
          className="p-5 rounded-3xl border space-y-6 glass-surface"
          style={{ borderColor: "var(--color-border)" }}
        >
          ...
          <div
            className="grid sm:grid-cols-2 gap-6 pt-4 border-t"
            style={{ borderColor: "var(--color-border)" }}
          >
            {/* Paragraph Mode */}
            <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {(
                  ...
                  ] as { id: ReaderWidth; label: string }[]
                ).map((w) => (
                  <button
                    key={w.id}
